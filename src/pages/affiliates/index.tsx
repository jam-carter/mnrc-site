    ...
    return (
        <div className={styles.affiliatesPage}>
            ...
            <div className={styles.contentBox}>
                ...
                <p className={styles.description}>
                    Don’t forget to check out our <a href="/affiliates/sponsers" className={styles.placeholderLink}>Sponsors</a> who play a vital role in supporting our community and making these clubs thrive.
                </p>
